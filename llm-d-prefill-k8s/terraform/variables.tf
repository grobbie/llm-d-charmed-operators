...
variable "constraints" {
  ...
  default     = "cores=4 mem=32G tags=anti-pod.app.kubernetes.io/name=llm-d-prefill-k8s|llm-d-decode-k8s,anti-pod.topology-key=kubernetes.io/hostname"
}
